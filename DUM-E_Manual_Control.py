...
def Claw_Open():
    ...
    pwm_Claw.ChangeDutyCycle(abs(speed))
...
def Wrist_Up():
    ...
    pwm_Wrist.ChangeDutyCycle(abs(speed))
...
def Elbow_Up():
    ...
    pwm_Elbow.ChangeDutyCycle(abs(speed))
...
def Shoulder_Vertical_Up():
    ...
    pwm_Shoulder_Vertical.ChangeDutyCycle(abs(speed))
...
def Shoulder_Horizontal_Right():
    ...
    pwm_Shoulder_Horizontal.ChangeDutyCycle(abs(speed))
