...
def Claw_Open():
    ...
    GPIO.output(int(pwm_Claw), True)
    sleep(int(speed))
    GPIO.output(Claw_DC_Motor_1, False)
    GPIO.output(Claw_DC_Motor_2, False)
    GPIO.outputint(int(pwm_Claw), False)
    pwm_Claw.stop()
...
def Claw_Close():
    ...
    GPIO.output(Claw_DC_Motor_1, False)
    GPIO.output(Claw_DC_Motor_1, False)
    GPIO.output(int(pwm_Claw), False)
    pwm_Claw.stop()
...
def Wrist_Up():
    ...
    GPIO.output(int(pwm_Wrist), True)
    sleep(int(speed))
    GPIO.output(Wrist_DC_Motor_1, False)
    GPIO.output(Wrist_DC_Motor_2, False)
    GPIO.output(int(pwm_Wrist), False)
    pwm_Wrist.stop()
...
def Elbow_Up():
    ...
    GPIO.output(int(pwm_Elbow), True)
    sleep(int(speed))
    GPIO.output(Elbow_DC_Motor_1, False)
    GPIO.output(Elbow_DC_Motor_2, False)
    GPIO.output(int(pwm_Elbow), False)
    pwm_Elbow.stop()
...
def Shoulder_Vertical_Up():
    ...
    GPIO.output(int(pwm_Shoulder_Vertical), True)
    sleep(int(speed))
    GPIO.output(Shoulder_Vertical_DC_Motor_1, False)
    GPIO.output(Shoulder_Vertical_DC_Motor_2, False)
    GPIO.output(int(pwm_Shoulder_Vertical), False)
...
def Shoulder_Horizontal_Right():
    ...
    GPIO.output(int(pwm_Shoulder_Horizontal), True)
    sleep(int(speed))
    GPIO.output(Shoulder_Horizontal_DC_Motor_1, False)
    GPIO.output(Shoulder_Horizontal_DC_Motor_1, False)
    GPIO.output(int(pwm_Shoulder_Horizontal), False)
