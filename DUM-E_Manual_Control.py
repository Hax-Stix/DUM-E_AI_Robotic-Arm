...
def Claw_Open():
    ...
    pwm_Claw.ChangeDutyCycle(speed)
...
def Wrist_Up():
    ...
    pwm_Wrist.ChangeDutyCycle(speed)
...
def Elbow_Up():
    ...
    pwm_Elbow.ChangeDutyCycle(speed)
...
def Shoulder_Vertical_Up():
    ...
    pwm_Shoulder_Vertical.ChangeDutyCycle(speed)
...
def Shoulder_Horizontal_Right():
    ...
    pwm_Shoulder_Horizontal.ChangeDutyCycle(speed)
