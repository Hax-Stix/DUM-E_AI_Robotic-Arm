...
def Claw_Open():
    ...
    pwm_Claw.ChangeDutyCycle(float(speed))
...
def Wrist_Up():
    ...
    pwm_Wrist.ChangeDutyCycle(float(speed))
...
def Elbow_Up():
    ...
    pwm_Elbow.ChangeDutyCycle(float(speed))
...
def Shoulder_Vertical_Down():
    ...
    pwm_Shoulder_Vertical.ChangeDutyCycle(float(speed))
...
def Shoulder_Horizontal_Right():
    ...
    pwm_Shoulder_Horizontal.ChangeDutyCycle(float(speed))
